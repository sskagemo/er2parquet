...
Welcome to `er2parquet` contributor's guide.
...
If you experience bugs or general issues with `er2parquet`, please have a look
...
You can help improve `er2parquet` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`er2parquet` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `er2parquet`'s files. While this mechanism can
...
```
conda create -n er2parquet python=3 six virtualenv pytest pytest-cov
conda activate er2parquet
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/er2parquet.git
   cd er2parquet
   ```
...
5. Install [pre-commit]:
   ...
   `er2parquet` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/er2parquet
[issue tracker]: https://github.com/<USERNAME>/er2parquet/issues
